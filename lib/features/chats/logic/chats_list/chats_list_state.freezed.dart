...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ChatsListState);
}
...
/// @nodoc
class $ChatsListStateCopyWith<$Res>  {
$ChatsListStateCopyWith(ChatsListState _, $Res Function(ChatsListState) __);
}


/// Adds pattern-matching-related methods to [ChatsListState].
extension ChatsListStatePatterns on ChatsListState {
...
class _Initial implements ChatsListState {
  const _Initial();
...
class _Loading implements ChatsListState {
  const _Loading();
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $ChatsListStateCopyWith<$Res> {
...
class _Error implements ChatsListState {
...
@override
String toString() {
  return 'ChatsListState.error(message: $message)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ChatsListStateCopyWith<$Res> {
