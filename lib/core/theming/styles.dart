...
class TextStyles {
  ...
  static TextStyle font18CyanSemiBold = TextStyle(
    fontSize: 18.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.mainColor,
    height: 1.4,
  ...
  static TextStyle font16CyanSemiBold = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.mainColor,
    height: 1.5,
  ...
  static TextStyle font16CyanMedium = TextStyle(
    fontSize: 16.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.mainColor,
    height: 1.5,
  ...
  static TextStyle font14CyanMedium = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.medium,
    color: ColorsManager.mainColor,
    height: 1.5,
  ...
  static TextStyle priceStyleMedium = TextStyle(
    fontSize: 18.sp,
    fontWeight: FontWeightHelper.bold,
    color: ColorsManager.mainColor,
    height: 1.3,
  ...
  static TextStyle priceStyleSmall = TextStyle(
    fontSize: 14.sp,
    fontWeight: FontWeightHelper.semiBold,
    color: ColorsManager.mainColor,
    height: 1.4,
