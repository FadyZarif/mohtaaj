...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is VerifyEmailRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.verificationCode, verificationCode) || other.verificationCode == verificationCode));
}
...
@override
String toString() {
  return 'VerifyEmailRequest(email: $email, verificationCode: $verificationCode)';
}
...
class _VerifyEmailRequest implements VerifyEmailRequest {
  const _VerifyEmailRequest({required this.email, required this.verificationCode});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _VerifyEmailRequest&&(identical(other.email, email) || other.email == email)&&(identical(other.verificationCode, verificationCode) || other.verificationCode == verificationCode));
}
